...
#define VCOM_EN         BEAGLEBONE_GPIO(2,00)	//P2.20 //P9-26 // VCOM switch enable
#define PMIC_EN           BEAGLEBONE_GPIO(0,27) //P2.19 //P8-16 // HV-PMIC enable
#define PMIC_POK          BEAGLEBONE_GPIO(1,10) //P1.32 //P9-24 // HV-PMIC power OK
#define PMIC_FLT          BEAGLEBONE_GPIO(3,15) //P1.33 //P8-17 // HV-PMIC fault condition

#define RUDDOCK_HIRQ   		BEAGLEBONE_GPIO(1,15)  //P2.18 //P9-25
#define RUDDOCK_HDC    		BEAGLEBONE_GPIO(1,28)  //P2.08 //P9-23
#define RUDDOCK_RESET  		BEAGLEBONE_GPIO(2,01)  //P2.17 //P8-14
#define RUDDOCK_CS   		BEAGLEBONE_GPIO(1,20)   //P2.10  //P9-17
#define RUDDOCK_HRDY      	BEAGLEBONE_GPIO(0,20)  //P1.20 //P9-27
#define RUDDOCK_5V_EN		BEAGLEBONE_GPIO(1,27)  //P2.02 //P8-15
#define RUDDOCK_RESERVE_2	BEAGLEBONE_GPIO(0,26)  //P1.34 //P8-11
...
#define CHIFFCHAFF_32MHZ_EN BEAGLEBONE_GPIO(3,14)  //P1.36	//P8-19 //Reserve1
#define CHIFFCHAFF_CS		BEAGLEBONE_GPIO(0,23)  //P2.03 //P9-15
#define CHIFFCHAFF_NVM_CS	BEAGLEBONE_GPIO(1,26)  //P2.04 //P9-13 //SEL
